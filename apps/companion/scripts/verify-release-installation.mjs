...
assert.equal(candidate.manifest.version, '0.3.0', 'La ruta de actualización debe medir el candidato 0.3.0.');
...
try {
  ...
  assert.equal((await installedManifest()).version, candidate.manifest.version, 'La actualización no contiene 0.3.0.');
