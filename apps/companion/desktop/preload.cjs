...
const methods = ['listProjects','chooseFolder','openProject','forgetProject','previewBase','applyBase','previewEnvironment','applyEnvironment','profileCatalog','stackCatalog','previewStack','applyStack','declineStack','removeStack','previewRepair','applyRepair','previewEngineering','applyEngineering','previewActivation','applyActivation','rollbackEngineering','previewContext','applyContext','previewCode','applyCode','searchCode','previewSync','status','recover','search','workspace','guide','copyGuideStep','copyText','inferenceStatus','setInference','providerModels','promptPreview','investigationPrompt','applyNotes','exportPreview','copyExport','handoffPreview','handoff','cancel','job'];
