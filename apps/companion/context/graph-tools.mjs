...
import {READABLE_PROFILE_IDS, isEngineering} from '../engine/profiles.mjs';
...
const CANDIDATES = [
  { id: 'codegraph', package: '@colbymchenry/codegraph', version: '1.6.0', license: 'MIT',
    homepage: 'https://github.com/colbymchenry/codegraph', artifact: '.codegraph', profiles: READABLE_PROFILE_IDS.filter(isEngineering),
  ...
  { id: 'graphify', package: 'graphifyy', version: null, observedVersion: '0.9.56', license: 'Apache-2.0',
    homepage: 'https://github.com/Graphify-Labs/graphify', artifact: 'graphify-out', profiles: READABLE_PROFILE_IDS,
  ...
  { id: 'gitnexus', package: 'gitnexus', version: '1.6.10', license: 'PolyForm-Noncommercial-1.0.0',
    homepage: 'https://github.com/abhigyanpatwari/GitNexus', artifact: '.gitnexus', profiles: READABLE_PROFILE_IDS.filter(isEngineering),
...
export async function graphOptions(target, profile) {
  if (!READABLE_PROFILE_IDS.includes(profile)) fail('PROFILE_INVALID', 'Elige un perfil válido.');
