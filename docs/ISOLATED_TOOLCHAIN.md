...
Companion ya proporciona esa preparación visual; consulta [el entorno de la app en GitHub](https://github.com/IgnacioBarEsp/project-engineering-os/blob/main/docs/companion/ENVIRONMENT.md).
