...
| Opciones asistidas del instalador de #168 | Release 0.3.6 publicada; las opciones y páginas en español se verificaron en Sandbox. Archive y cierre formal del issue pendientes | [change activo](../openspec/changes/companion-installer-choices/README.md) |
