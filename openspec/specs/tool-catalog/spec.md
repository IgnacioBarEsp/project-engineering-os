...
## Purpose
Define a versioned, read-only tool evaluation contract that records provenance, permissions, cost and verification without installing or activating candidates.
## Requirements
