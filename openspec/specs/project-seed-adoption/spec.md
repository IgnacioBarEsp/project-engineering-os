# project-seed-adoption Specification

## Purpose
Adopt existing project-owned seed files through explicit target and hash consent while preserving their
bytes. Keep ownership, transaction recovery and runtime activation distinct and verifiable.
## Requirements
