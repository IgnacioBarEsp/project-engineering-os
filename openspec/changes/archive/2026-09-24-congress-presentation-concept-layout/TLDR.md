...
seven concept slides, then rebuild and visually verify the complete 22-page PDF before publishing the
downloadable artifacts and linking them from #165. This is documentation-only; no product code or new
published dependency is introduced.
