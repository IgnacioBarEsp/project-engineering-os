...
- `npm exec --yes --package=npm@11.19.1 -- npm run pack:verify` sobre `56e34402537e06f91368836ea384378b0accd0bb`: PASS; instaló el tarball y verificó versión, CLI/help, bootstrap, segundo run y deuda. SHA `bedb51389bc50951f22a3c14753ac4dcb537e1775fd83d5e09fa3dc7b529f486`, 266.291 bytes, 167 archivos y 1.019.023 bytes sin comprimir. Se repetirá tras el commit de archive, que solo agregará evidencia y metadatos OpenSpec al paquete fuente.
